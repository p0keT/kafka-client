...
public class KafkaConsumerConfig {
    ...
    //*************************************************************************************************
    @Bean
    public KafkaListenerContainerFactory<?> batchReportStatusFactory() {
        ConcurrentKafkaListenerContainerFactory<Long, ReportStatus> factory =
                new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(consumerReportStatusFactory());
    ...
    @Bean
    public KafkaListenerContainerFactory<?> singleReportStatusFactory() {
        ConcurrentKafkaListenerContainerFactory<Long, ReportStatus> factory =
                new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(consumerReportStatusFactory());
    ...
    @Bean
    public ConsumerFactory<Long, ReportStatus> consumerReportStatusFactory() {
